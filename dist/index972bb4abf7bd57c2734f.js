...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-btn').on('click', function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').toggleClass('show');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').toggleClass('lock');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').toggleClass('show');
  });
  scrollHeader();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).resize(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).innerWidth() >= 769) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('lock');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-btn').removeClass('open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger-menu').removeClass('show');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('header').removeClass('show');
    }
    scrollHeader();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll', scrollHeader);
  function scrollHeader() {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).innerWidth() < 769) {
      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > 1) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header').addClass('scroll');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header').removeClass('scroll');
      }
    }
  }
  ...
  const collectionSwiper = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.main-collection__cards', {
    enabled: true,
    slidesPerView: 'auto',
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!./node_modules/sass-loader/dist/cjs.js!./node_modules/swiper/swiper.css":
/*!*************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!./node_modules/sass-loader/dist/cjs.js!./node_modules/swiper/swiper.css ***!
  \*************************************************************************************************************************************************/
...
@media (max-width: 48em) {
  ...
  .burger-btn.open .burger-btn__btn {
    display: none;
  }
  .burger-btn.open .burger-btn__close {
    display: block;
    width: 4rem;
    height: 4rem;
  }
  ...
  .burger-menu__phone {
    ...
    flex-direction: column;
    align-items: center;
    border-top: 0.2rem solid #c9fb40;
  ...
  .burger-menu__phone a span {
    width: 6.4rem;
    height: 6.4rem;
  }
  .burger-menu__phone a span svg path {
    fill: #ed89fb;
  }
  .burger-menu__phone a strong {
    color: #ed89fb;
    font-size: 4.8rem;
    font-style: normal;
    font-weight: 500;
  ...
  .burger-menu__link {
    ...
    padding: 3.2rem 0;
    border-bottom: 0.2rem solid #c9fb40;
  }
  .burger-menu__link:first-child {
    border-top: 0.2rem solid #c9fb40;
  }
  .burger-menu__link:hover, .burger-menu__link:active, .burger-menu__link:focus-visible {
...
.footer__phone:hover, .footer__phone:focus-visible, .footer__phone:active {
...
.footer__politic:hover::after, .footer__politic:focus-visible::after {
  display: none;
}
.footer__bottom-text {
  line-height: 0.86;
...
.footer-sitemap__item:nth-child(1) .sitemap-item__list {
  grid-template-columns: repeat(3, 1fr);
}
.footer-sitemap__item:nth-child(2) .sitemap-item__list {
  grid-template-columns: 1fr;
}
.footer-sitemap__item:nth-child(3) {
  margin-left: auto;
}
.footer-sitemap__item:nth-child(3) .sitemap-item__list {
...
.sitemap-item__link:hover, .sitemap-item__link:focus-visible, .sitemap-item__link:active {
  text-decoration: underline;
}
...
@media (max-width: 48em) {
  ...
  .footer-sitemap__item:nth-child(1) {
    grid-row: span 2;
  }
  .footer-sitemap__item:nth-child(3) {
    margin-left: 0;
...
@media (any-hover: hover) {
  .btn:hover:not(.btn:hover.btn_black) {
...
.hero-gallery__title.tl1 {
  font-size: 19rem;
}
.hero-gallery__title ._coloured-txt {
  color: #c9fb40;
}
.hero-gallery__body {
  position: relative;
...
.hero-gallery__item._a {
  top: 0;
  left: 0;
  width: 8.6rem;
  height: 8rem;
}
.hero-gallery__item._b {
  top: 0;
  left: 10.8rem;
  width: 14.3rem;
  height: 8.8rem;
}
.hero-gallery__item._c {
  top: 0;
  left: 28.2rem;
  width: 26.3rem;
  height: 12.2rem;
}
.hero-gallery__item._d {
  top: 0;
  left: 57.3rem;
  width: 15.8rem;
  height: 10.2rem;
}
.hero-gallery__item._e {
  top: 0;
  left: 76rem;
  width: 29.7rem;
  height: 10.7rem;
}
.hero-gallery__item._f {
  top: 0;
  left: 108.9rem;
  width: 12.4rem;
  height: 10.2rem;
}
.hero-gallery__item._g {
  top: 0;
  left: 124.4rem;
  width: 19rem;
  height: 9.6rem;
}
.hero-gallery__item._h {
  top: 0;
  right: 0;
  width: 26.3rem;
  height: 29rem;
}
.hero-gallery__item._i {
  top: 11.3rem;
  left: 0;
  width: 25.1rem;
  height: 12.6rem;
}
.hero-gallery__item._j {
  top: 14.7rem;
  left: 27.7rem;
  width: 9.2rem;
  height: 9.2rem;
}
.hero-gallery__item._k {
  top: 14.6rem;
  left: 39.2rem;
  width: 14.4rem;
  height: 9.4rem;
}
.hero-gallery__item._l {
  top: 13.2rem;
  left: 55.8rem;
  width: 27.8rem;
  height: 13.4rem;
}
.hero-gallery__item._m {
  top: 13.2rem;
  left: 86.5rem;
  width: 26.9rem;
  height: 13.4rem;
}
.hero-gallery__item._n {
  top: 13.2rem;
  left: 115.9rem;
  width: 26.8rem;
  height: 23.5rem;
}
.hero-gallery__item._o {
  top: 26.3rem;
  left: 1.9rem;
  width: 23.2rem;
  height: 13.2rem;
}
.hero-gallery__item._p {
  top: 26.3rem;
  left: 27.7rem;
  width: 18.4rem;
  height: 10.4rem;
}
.hero-gallery__item._q {
  top: 29.2rem;
  left: 48.9rem;
  width: 18.8rem;
  height: 10.1rem;
}
.hero-gallery__item._r {
  top: 29.2rem;
  left: 70.2rem;
  width: 12.1rem;
  height: 15rem;
}
.hero-gallery__item._s {
  top: 29.2rem;
  left: 84.8rem;
  width: 27.8rem;
  height: 15.8rem;
}
.hero-gallery__item._t {
  top: 39.1rem;
  left: 116.2rem;
  width: 22.3rem;
  height: 14.2rem;
}
.hero-gallery__item._u {
  top: 39rem;
  left: 140.5rem;
  width: 6.4rem;
  height: 5.2rem;
}
.hero-gallery__item._v {
  top: 31.4rem;
  left: 149.2rem;
  width: 9.1rem;
  height: 18.3rem;
}
.hero-gallery__item._w {
  top: 31.4rem;
  right: 0;
  width: 11.4rem;
  height: 8.1rem;
}
.hero-gallery__item._x {
  top: 41.7rem;
  left: 11.9rem;
  width: 11.5rem;
  height: 6.5rem;
}
.hero-gallery__item._y {
  top: 39.1rem;
  left: 26.1rem;
  width: 21rem;
  height: 10.9rem;
}
.hero-gallery__item._z {
  top: 42.1rem;
  left: 49.5rem;
  width: 14.1rem;
  height: 11.5rem;
}
.hero-gallery__item._a1 {
  top: 47.4rem;
  left: 65.9rem;
  width: 17.1rem;
  height: 15.7rem;
}
.hero-gallery__item._b1 {
  top: 49.5rem;
  left: 85.4rem;
  width: 14.3rem;
  height: 13.6rem;
}
.hero-gallery__item._c1 {
  top: 48.6rem;
  left: 102.2rem;
  width: 11.4rem;
  height: 8.1rem;
}
.hero-gallery__item._d1 {
  top: 39.1rem;
  left: 116.2rem;
  width: 22.3rem;
  height: 14.2rem;
}
.hero-gallery__item._e1 {
  top: 45.7rem;
  left: 140.9rem;
  width: 5.7rem;
  height: 5.7rem;
}
.hero-gallery__item._f1 {
  top: 41.5rem;
  right: 0;
  width: 10.4rem;
  height: 6.6rem;
...
}`, "",{"version":3,"sources":["webpack://./src/scss/fonts.scss","webpack://./src/scss/style.scss","webpack://./src/scss/set.scss","webpack://./src/scss/sections/header.scss","webpack://./src/scss/sections/footer.scss","webpack://./src/ui/typo.scss","webpack://./src/ui/buttons.scss","webpack://./src/ui/inputs.scss","webpack://./src/ui/tabs.scss","webpack://./src/ui/accordion.scss","webpack://./src/ui/select.scss","webpack://./src/ui/radio-btns.scss","webpack://./src/ui/social.scss","webpack://./src/scss/sections/_hero-gallery.scss","webpack://./src/scss/sections/_main-collections.scss","webpack://./src/scss/sections/_main-links.scss","webpack://./src/scss/sections/_main-rates.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,gBAAA;EACA,+DAAA;ACCF;ADEA;EACE,8BAAA;EACA,gBAAA;EACA,sEAAA;ACAF;ADGA;EACE,8BAAA;EACA,gBAAA;EACA,uEAAA;ACDF;ADIA;EACE,8BAAA;EACA,gBAAA;EACA,yEAAA;ACFF;ACnBA;;;EAGI,sBAAA;ADqBJ;;ACnBA;EACI,8BAAA;EACA,sBAAA;EACA,kBAAA;EACA,mBAAA;EACA,qCAAA;EACA,gBAAA;EACA,SAAA;EACA,UAAA;ADsBJ;;ACnBA;EACI,kBAAA;EACA,mBAAA;EACA,qCAAA;EACA,gBAAA;EACA,SAAA;EACA,UAAA;EACA,cDdI;ECeJ,yBDbQ;AAmCZ;;ACnBA;;EAEI,qCAAA;EACA,oBAAA;EACA,SAAA;EACA,UAAA;EACA,6BAAA;EACA,YAAA;EACA,cAAA;ADsBJ;;ACpBA;EACI,YAAA;ADuBJ;;ACrBA;;EAEI,qBAAA;ADwBJ;;ACrBA;;;;EAII,aAAA;EACA,eAAA;EACA,aAAA;ADwBJ;ACvBI;;;;EACI,aAAA;AD4BR;AC1BI;;;;EACI,aAAA;AD+BR;;AC3BA;;;;;;EAMI,aAAA;EACA,SAAA;EACA,UAAA;AD8BJ;;AC5BA;EACI,aAAA;EACA,gBAAA;AD+BJ;;AC5BA;EACI,WAAA;EACA,YAAA;EACA,cAAA
DQ;EACI,cAAA;Af4sDZ;Ae1sDY;EACI,cAAA;EACA,gBAAA;EACA,kBAAA;Af4sDhB;Ae1sDY;EACI,oBAAA;EACA,qBAAA;Af4sDhB;Ae1sDY;EACI,sBAAA;Af4sDhB;AezsDQ;EACI,cfnFL;AA8xDP;AevsDI;EACI,YAAA;EACA,cfzFD;AAkyDP;AetsDI;EACI,kBAAA;AfwsDR;;AepsDI;EACI,UAAA;EACA,aAAA;EACA,aAAA;EACA,YAAA;EACA,4BAAA;AfusDR;AersDI;EACI,cAAA;EACA,YAAA;EACA,aAAA;EACA,YAAA;EACA,yBAAA;AfusDR;AersDI;EACI,aAAA;EACA,YAAA;EACA,6BAAA;EACA,cAAA;EACA,eAAA;AfusDR;;AensDA;EAGQ;IACI,UAAA;EfosDV;EejsDM;IACI,aAAA;IACA,mBAAA;IACA,sBAAA;EfmsDV;Ee/rDM;IAEI,WAAA;IACA,YAAA;EfgsDV;Ee9rDM;IACI,cAAA;EfgsDV;Ee9rDM;IACI,aAAA;EfgsDV;Ee7rDM;IACI,eAAA;IACA,eAAA;IACA,WAAA;IACA,uBAAA;IACA,eAAA;IACA,oCAAA;Ef+rDV;Ee5rDM;IACI,eAAA;Ef8rDV;Ee3rDM;IACI,sBAAA;IACA,WAAA;IACA,SAAA;IACA,YAAA;IACA,eAAA;IACA,mBAAA;Ef6rDV;EexrDc;IACI,cAAA;Ef0rDlB;EexrDc;IACI,oBAAA;IACA,gBAAA;Ef0rDlB;EexrDc;IACI,sBAAA;Ef0rDlB;EevrDU;IACI,cftLT;EA+2DL;EerrDM;IACI,UAAA;IACA,kBAAA;IAEA,aAAA;IACA,uBAAA;IACA,qBAAA;EfsrDV;EenrDM;IACI,aAAA;EfqrDV;AACF","sourcesContent":["@font-face {\n  font-family: 'DrukCyr';\n  font-weight: 500;\n  src: url('./assets/fonts/DrukCyr-Medium.woff2') format('woff2');\n}\n\n@font-face {\n  font-family: 'EuclidCircularA';\n  font-weight: 400;\n  src: url('./assets/fonts/EuclidCircularA-Regular.woff') format('woff');\n}\n\n@font-face {\n  font-family: 'EuclidCircularA';\n  font-weight: 500;\n  src: url('./assets/fonts/EuclidCircularA-Medium.woff2') format('woff2');\n}\n\n@font-face {\n  font-family: 'EuclidCircularA';\n  font-weight: 600;\n  src: url('./assets/fonts/EuclidCircularA-SemiBold.woff2') format('woff2');\n}\n","// --------------------------------- mixins ---------------------------------\n\n@import './mixins';\n\n// -------------------------------- variables -------------------------------\n\n$font: 'EuclidCircularA';\n\n// colors\n$white: #ffffff;\n$black: #000000;\n$bodyColor: #1f1f22;\n$pink: #ed89fb;\n$violet: #cad2f4;\n$green: #c9fb40;\n$yellow: #fad85d;\n$darkGray: #6a6a6a;\n$main: #282828;\n$red: #ff1212;\n$gray: #6a6a6a;\n\n// ---------------------------------- fonts ---------------------------------\n\n// local fonts\n@import './fonts';\n\n// ------------------------------- base styles ------------------------------\n\n// base scss file\n@import './set';\n\n// body\nbody {\n    &.lock {\n        overflow: hidden;\n        touch-action: none;\n    }\n}\n\n// main\nmain {\n    overflow: hidden;\n    padding-top: 6.7rem;\n    @media (max-width: 48em) {\n        padding-top: 12.6rem;\n    }\n}\n\n.desktop {\n    @media (max-width: 48em) {\n        display: none;\n    }\n}\n\n.mobile {\n    display: none;\n\n    @media (max-width: 48em) {\n        display: block;\n    }\n}\n\n// --------------------------------------------------------------------------\n\n// header / footer\n@import './sections/header';\n@import './sections/footer';\n\n// ui\n@import '../ui/ui.scss';\n\n// --------------------------------------------------------------------------\n\n@import './dev/vzmsk1.scss';\n@import './dev/markusDM.scss';\n@import './dev/ukik0.scss';\n@import './dev/kie6er.scss';\n","*,\n*::before,\n*::after {\n    box-sizing: border-box;\n}\nhtml {\n    font-family: 'EuclidCircularA'; // шрифт по умолчанию по сайту\n    font-size: 0.5208335vw; // на разрешении 1920 0.520835vw === 10px\n    font-style: normal;\n    font-weight: normal;\n    -webkit-animation: bugfix infinite 1s;\n    line-height: 1.2;\n    margin: 0;\n    padding: 0;\n}\n\nbody {\n    font-style: normal;\n    font-weight: normal;\n    -webkit-animation: bugfix infinite 1s;\n    line-height: 1.2;\n    margin: 0;\n    padding: 0;\n    color: $white; // цвет по умолчанию текста по сайту\n    background-color: $bodyColor;\n}\n\ninput,\ntextarea {\n    -webkit-animation: bugfix infinite 1s;\n    line-height: inherit;\n    margin: 0;\n    padding: 0;\n    background-color: transparent;\n    border: none;\n    color: inherit;\n}\na {\n    color: unset;\n}\na,\na:hover {\n    text-decoration: none;\n}\n\nbutton,\ninput,\na,\ntextarea {\n    outline: none;\n    cursor: pointer;\n    font: inherit;\n    &:focus {\n        outline: none;\n    }\n    &:active {\n        outline: none;\n    }\n}\n\nh1,\nh2,\nh3,\nh4,\nh5,\nh6 {\n    font: inherit;\n    margin: 0;\n    padding: 0;\n}\np {\n    margin-top: 0;\n    margin-bottom: 0;\n}\n\nimg {\n    width: 100%;\n    height: auto;\n    display: block;\n}\n\nbutton {\n    border: none;\n    color: inherit;\n    font: inherit;\n    text-align: inherit;\n    padding: 0;\n    background-color: transparent;\n}\nul {\n    padding: 0;\n    margin: 0;\n}\n\nul li {\n    margin: 0;\n    padding: 0;\n    list-style: none;\n}\n\n.container {\n    width: 172rem;\n    margin: 0 auto;\n}\n\ninput[type='number']::-webkit-inner-spin-button,\ninput[type='number']::-webkit-outer-spin-button {\n    -webkit-appearance: none;\n    margin: 0;\n}\n\ninput[type='number'] {\n    -moz-appearance: textfield;\n}\n\nsvg,\nimg {\n    width: 100%;\n    height: auto;\n    object-fit: contain;\n}\n\n@media (min-width: 1920px) {\n    html {\n        font-size: 10px;\n    }\n}\n\n@media (max-width: 48em) {\n    html {\n        font-size: 5px;\n        font-size: 1.5625vw;\n        font-size: calc((100 / 375) * 5vw); // где 375 это ширина моб версии макета\n        -webkit-text-size-adjust: none;\n    }\n\n    body {\n        -webkit-text-size-adjust: none;\n    }\n\n    .container {\n        padding: 0 2rem; // в моб версии отступ от края задаем для всех контейнеров, а там где не нужно можем точечно убрать\n        width: 100%;\n    }\n}\n",".header {\n    position: fixed;\n    width: 100%;\n    top: 0;\n    left: 0;\n    z-index: 1000;\n\n    background-color: $bodyColor;\n    border-bottom: 0.1rem solid rgba(201, 251, 64, 0.5);\n    // .header__inner\n    &__inner {\n        display: flex;\n        align-items: center;\n        justify-content: space-between;\n        gap: 1rem;\n    }\n    // .header__burger-btn\n    &__burger-btn {\n        display: none;\n    }\n    // .header__logo\n    &__logo {\n        padding: 1rem 0;\n        height: 100%;\n        width: 22.7rem;\n        border-right: 0.1rem solid rgba(201, 251, 64, 0.5);\n    }\n    // .header__img\n    &__img {\n        width: 17.9878rem;\n        height: 4.6rem;\n    }\n    // .header__nav\n    &__nav {\n        gap: 5rem;\n    }\n    &__burger-menu {\n        display: none;\n        overflow: auto;\n    }\n}\n\n.nav {\n    display: flex;\n    align-items: center;\n    // .nav__link\n    &__link {\n        display: block;\n        font-size: 2rem;\n        line-height: 140%; /* 28px */\n        transition: color 0.2s linear;\n\n        &:hover,\n        &:focus-visible {\n            transition: color 0.2s linear;\n            color: $green;\n        }\n    }\n}\n\n@media (max-width: 48em) {\n    .header {\n        border-bottom: none;\n        &.scroll {\n            border-bottom: 0.1rem solid rgba(201, 251, 64, 0.5);\n        }\n\n        &.show {\n            .header__phone {\n                display: none;\n            }\n            .header__inner {\n                flex-direction: row-reverse;\n            }\n        }\n        &__container {\n            position: relative;\n            z-index: 1;\n            background-color: $bodyColor;\n        }\n        // .header__inner\n        &__inner {\n            display: flex;\n            align-items: center;\n            justify-content: space-between;\n            gap: 1rem;\n            padding: 1.6rem 0 1.8rem;\n        }\n        // .header__burger-btn\n        &__burger-btn {\n            display: flex;\n            width: 5.2rem;\n            height: 4.6rem;\n        }\n        // .header__logo\n        &__logo {\n            padding: 0;\n            height: 9.2rem;\n            width: 36.6rem;\n            border-right: none;\n        }\n        // .header__img\n        &__img {\n            width: 100%;\n            height: 100%;\n        }\n        // .header__nav\n        &__nav {\n            display: none;\n        }\n        // .header__phone\n        &__phone {\n            width: 4.8rem;\n            height: 4.8rem;\n        }\n    }\n}\n@media (max-width: 48em) {\n    .burger-btn {\n        &__btn {\n            width: 100%;\n            height: 100%;\n\n            display: flex;\n            justify-content: center;\n            flex-direction: column;\n            gap: 1.4rem;\n\n            span {\n                display: block;\n                width: 100%;\n                height: 0.6rem;\n                background-color: $white;\n                border-radius: 2.4rem;\n            }\n        }\n\n        &__close {\n            display: none;\n        }\n\n        &.open {\n            .burger-btn__btn {\n                display: none;\n            }\n            .burger-btn__close {\n                display: block;\n                width: 4rem;\n                height: 4rem;\n            }\n        }\n    }\n\n    .burger-menu {\n        display: flex;\n        flex-direction: column;\n        justify-content: space-between;\n        gap: 15rem;\n        position: absolute;\n        top: 12.6rem;\n        left: 0;\n        z-index: 0;\n        transition: transform 0.5s linear;\n        transform: translateY(-120%);\n\n        width: 100%;\n        height: calc(100vh - 12.6rem);\n        background-color: $bodyColor;\n\n        &.show {\n            transition: transform 0.5s linear;\n            transform: translateY(0);\n        }\n        // .burger-menu__wrapper\n        &__wrapper {\n            display: flex;\n            align-items: center;\n            flex-direction: column;\n            padding-top: 16rem;\n        }\n        &__phone {\n            display: flex;\n            flex-direction: column;\n            align-items: center;\n            border-top: 0.2rem solid $green;\n\n            padding: 3.2rem 0 4.4rem;\n            a {\n                display: flex;\n                align-items: center;\n                gap: 2.6rem;\n                span {\n                    width: 6.4rem;\n                    height: 6.4rem;\n                    svg path {\n                        fill: $pink;\n                    }\n                }\n\n                strong {\n                    color: $pink;\n                    font-size: 4.8rem;\n                    font-style: normal;\n                    font-weight: 500;\n                    line-height: normal;\n                }\n            }\n        }\n        // .burger-menu__link\n        &__link {\n            display: flex;\n            justify-content: center;\n\n            width: 100%;\n            color: $white;\n            font-family: 'Druk Cyr';\n            font-size: 10rem;\n            font-style: normal;\n            font-weight: 500;\n            line-height: 110%; /* 55px */\n            text-transform: uppercase;\n            padding: 3.2rem 0;\n\n            border-bottom: 0.2rem solid $green;\n\n            &:first-child {\n                border-top: 0.2rem solid $green;\n            }\n\n            &:hover,\n            &:active,\n            &:focus-visible {\n                background-color: $pink;\n                color: $bodyColor;\n            }\n        }\n    }\n}\n",".footer {\n    background-color: $yellow;\n    color: $main;\n    // .footer__inner\n    &__inner {\n        padding: 7rem 0;\n    }\n    // .footer__top\n    &__top {\n        margin-bottom: 8rem;\n    }\n    // .footer__sitemap\n    &__sitemap {\n        gap: 20rem;\n    }\n    // .footer__middle\n    &__middle {\n        display: flex;\n        gap: 20rem;\n        align-items: flex-end;\n    }\n    // .footer__copyright\n    &__copyright {\n        color: $main;\n        font-size: 2rem;\n        width: 59.528rem;\n    }\n    // .footer__social\n    &__social {\n        gap: 1.6rem;\n    }\n    // .footer__info\n    &__info {\n        display: flex;\n        flex-direction: column;\n        margin-left: auto;\n        gap: 2.5rem;\n    }\n    // .footer__phone\n    &__phone {\n        color: $main;\n        font-size: 3.2rem;\n        line-height: normal;\n\n        &:hover,\n        &:focus-visible,\n        &:active {\n            text-decoration: underline;\n        }\n    }\n    // .footer__politic\n    &__politic {\n        color: $main;\n        font-size: 2rem;\n        line-height: normal;\n\n        position: relative;\n\n        &::after {\n            content: '';\n            width: 100%;\n            height: 0.15rem;\n            background-color: $main;\n\n            position: absolute;\n            left: 0;\n            bottom: 0;\n            z-index: 1;\n        }\n\n        &:hover,\n        &:focus-visible {\n            &::after {\n                display: none;\n            }\n        }\n    }\n    // .footer__bottom-text\n    &__bottom-text {\n        line-height: 0.86;\n        margin-top: 12rem;\n    }\n}\n.footer-sitemap {\n    display: flex;\n    // .footer-sitemap__item\n    &__item {\n        &:nth-child(1) {\n            .sitemap-item__list {\n                grid-template-columns: repeat(3, 1fr);\n            }\n        }\n        &:nth-child(2) {\n            .sitemap-item__list {\n                grid-template-columns: 1fr;\n            }\n        }\n        &:nth-child(3) {\n            margin-left: auto;\n            .sitemap-item__list {\n                grid-template-columns: repeat(2, 1fr);\n            }\n        }\n    }\n}\n.sitemap-item {\n    // .sitemap-item__title\n    &__title {\n        margin-bottom: 3.2rem;\n    }\n    // .sitemap-item__list\n    &__list {\n        line-height: normal;\n        display: grid;\n        gap: 2rem 8rem;\n    }\n    // .sitemap-item__link\n    &__link {\n        line-height: inherit;\n        white-space: nowrap;\n        background: none;\n\n        &:hover,\n        &:focus-visible,\n        &:active {\n            text-decoration: underline;\n        }\n    }\n}\n\n@media (max-width: 48em) {\n    .footer {\n        background-color: $yellow;\n        color: $main;\n        // .footer__inner\n        &__inner {\n            padding: 10rem 0 17.8rem;\n        }\n        // .footer__top\n        &__top {\n            margin-bottom: 8.4rem;\n        }\n        // .footer__sitemap\n        &__sitemap {\n            padding-left: 4.4rem;\n            gap: 3rem;\n        }\n        // .footer__middle\n        &__middle {\n            display: flex;\n            flex-direction: column;\n            gap: 2rem;\n            align-items: center;\n        }\n        // .footer__copyright\n        &__copyright {\n            order: 2;\n            text-align: center;\n            font-size: 2.4rem;\n            width: 100%;\n        }\n        // .footer__social\n        &__social {\n            gap: 6rem;\n            order: 3;\n            margin-top: 5.6rem;\n        }\n        // .footer__info\n        &__info {\n            text-align: center;\n            display: flex;\n            flex-direction: column;\n            margin-left: 0;\n            gap: 1rem;\n            order: 1;\n        }\n        // .footer__phone\n        &__phone {\n            font-size: 3.6rem;\n        }\n        // .footer__politic\n        &__politic {\n            color: $main;\n            font-size: 3rem;\n\n            position: relative;\n\n            &::after {\n                display: none;\n            }\n        }\n        // .footer__bottom-text\n        &__bottom-text {\n            text-align: center;\n            line-height: 1.1;\n            margin-top: 10.4rem;\n        }\n    }\n    .footer-sitemap {\n        display: grid;\n        grid-template-columns: repeat(2, 28rem);\n        grid-auto-flow: dense;\n        // .footer-sitemap__item\n        &__item {\n            &:nth-child(1) {\n                grid-row: span 2;\n            }\n            &:nth-child(3) {\n                margin-left: 0;\n            }\n        }\n    }\n    .sitemap-item {\n        // .sitemap-item__title\n        &__title {\n            margin-bottom: 2rem;\n        }\n        // .sitemap-item__list\n        &__list {\n            line-height: normal;\n            display: flex;\n            flex-direction: column;\n            gap: 1.6rem;\n        }\n        // .sitemap-item__link\n        &__link {\n            line-height: inherit;\n            white-space: nowrap;\n            background: none;\n\n            &:hover,\n            &:focus-visible,\n            &:active {\n                text-decoration: underline;\n            }\n        }\n    }\n}\n",".tl1,\n.tl2,\n.tl3 {\n    font-family: DrukCyr;\n    font-weight: 500;\n    text-transform: uppercase;\n}\n\n.tl1 {\n    font-size: 20rem;\n    line-height: 117%;\n    @media (max-width: 48em) {\n        font-size: 11rem;\n        line-height: 110%;\n    }\n}\n\n.tl2 {\n    line-height: 110%;\n    font-size: 10rem;\n}\n\n.tl3 {\n    font-size: 6rem;\n    line-height: 110%;\n    @media (max-width: 48em) {\n        font-size: 4rem;\n        letter-spacing: 0.32rem;\n    }\n}\n\n// --------------------------------------------------------------------------\n\n.txt32 {\n    font-size: 3.2rem;\n    @media (max-width: 48em) {\n        font-size: 3rem;\n        line-height: 140%;\n    }\n}\n\n.txt20 {\n    font-size: 2.8rem;\n    &_caps {\n        font-size: 4rem;\n        line-height: 110%;\n        letter-spacing: 0.32rem;\n        text-transform: uppercase;\n    }\n    &_md {\n        font-weight: 500;\n    }\n    @media (min-width: 48em) {\n        font-size: 2rem;\n        line-height: 140%;\n        &_caps {\n            font-size: 2.2rem;\n            font-weight: 500;\n            line-height: 109.091%;\n            letter-spacing: 0.176rem;\n        }\n    }\n}\n\n.txt28 {\n    &_md {\n        font-size: 2.8rem;\n        font-weight: 500;\n        @media (max-width: 48em) {\n            font-size: 3.6rem;\n        }\n    }\n}\n\n.txt16 {\n    font-size: 1.6rem;\n    @media (max-width: 48em) {\n        font-size: 2.4rem;\n    }\n}\n\n.text-32 {\n    font-size: 3.2rem;\n    font-style: normal;\n    font-weight: 400;\n    line-height: normal;\n}\n\n.text-m-28 {\n    font-size: 2.8rem;\n    font-style: normal;\n    font-weight: 500;\n    line-height: normal;\n}\n\n.text-m-20 {\n    font-family: 'DrukCyr';\n    font-size: 2.0093rem;\n    font-style: normal;\n    font-weight: 500;\n    line-height: 84%; /* 16.878px */\n    letter-spacing: 0.1607rem;\n}\n\n.text-20 {\n    font-size: 2rem;\n    font-style: normal;\n    font-weight: 400;\n    line-height: 140%; /* 28px */\n}\n",".btn {\n    padding: 1.3rem 1rem 1.3rem 2.8rem;\n    display: inline-flex;\n    justify-content: center;\n    align-items: center;\n    column-gap: 2.2rem;\n    border-radius: 9.5rem;\n    border: 1px solid $green;\n    transition: background-color 0.3s ease;\n    &_black {\n        border: 1px solid $black;\n        .btn__text {\n            color: $black;\n        }\n    }\n    @media (any-hover: hover) {\n        &:hover {\n            &:not(&.btn_black) {\n                background-color: $green;\n            }\n            &.btn_black {\n                background-color: $black;\n            }\n            .btn__text {\n                color: $white;\n            }\n            .btn__icon {\n                path {\n                    fill: $white;\n                }\n            }\n        }\n    }\n    @media (max-width: 48em) {\n        padding: 3rem 3.6rem 3rem 6rem;\n        column-gap: 3.2rem;\n        border-radius: 19rem;\n    }\n\n    // .btn__text\n    &__text {\n        font-family: DrukCyr;\n        color: $green;\n        transition: color 0.3s ease;\n    }\n\n    // .btn__icon\n    &__icon {\n        flex: 0 0 2.4rem;\n        width: 2.4rem;\n        height: 2.4rem;\n        path {\n            transition: fill 0.3s ease;\n        }\n        @media (max-width: 48em) {\n            flex: 0 0 5rem;\n            width: 5rem;\n            height: 5rem;\n        }\n    }\n}\n// <button type=\"button\" class=\"btn\">\n//       <span class=\"btn__text txt20 txt20_caps\">ОСТАВИТЬ ЗАЯВКУ</span>\n//       <svg\n//         class=\"btn__icon\"\n//         xmlns=\"http://www.w3.org/2000/svg\"\n//         width=\"24\"\n//         height=\"24\"\n//         viewBox=\"0 0 24 24\"\n//         fill=\"none\">\n//         <path\n//           d=\"M6.75586 19.2442V5.11624L17.1164 12.1802L6.75586 19.2442Z\"\n//           fill=\"#C9FB40\" />\n//       </svg>\n// </button>\n\n// --------------------------------------------------------------------------\n\n.showmore-btn {\n    display: flex;\n    align-items: center;\n    column-gap: 1.6rem;\n    @media (any-hover: hover) {\n        &:hover {\n            .showmore-btn__icon {\n                circle {\n                    fill: $white;\n                }\n                path {\n                    fill: $pink;\n                }\n            }\n        }\n    }\n    @media (max-width: 48em) {\n        column-gap: 2.4rem;\n    }\n\n    // .showmore-btn__icon\n\n    &__icon {\n        flex: 0 0 5.2rem;\n        width: 5.2rem;\n        height: 5.2rem;\n        border-radius: 50%;\n        circle,\n        path {\n            transition: fill 0.3s ease;\n        }\n        @media (max-width: 48em) {\n            flex: 0 0 8rem;\n            width: 8rem;\n            height: 8rem;\n        }\n    }\n\n    // .showmore-btn__text\n\n    &__text {\n        font-family: DrukCyr;\n        color: $pink;\n    }\n}\n// <button type=\"button\" class=\"showmore-btn\">\n//       <svg\n//         class=\"showmore-btn__icon\"\n//         width=\"52\"\n//         height=\"52\"\n//         viewBox=\"0 0 52 52\"\n//         fill=\"none\"\n//         xmlns=\"http://www.w3.org/2000/svg\">\n//         <circle cx=\"26\" cy=\"26\" r=\"26\" fill=\"#ED89FB\" />\n//         <path\n//           d=\"M31.6912 24.995C32.1412 25.895 32.3737 26.8625 32.3737 27.875C32.3737 31.3925 29.5162 34.25 25.9987 34.25C22.4812 34.25 19.6237 31.3925 19.6237 27.875C19.6237 24.3575 22.4812 21.5 25.9987 21.5C26.0512 21.5 26.1787 21.5 26.3137 21.545C26.5687 21.6275 26.7562 21.845 26.8087 22.1075C27.1237 23.615 28.4662 24.7175 30.0112 24.7175C30.2962 24.7175 30.5737 24.68 30.8137 24.6125C31.1662 24.515 31.5262 24.68 31.6912 24.995ZM25.9987 17.75C20.8687 17.75 15.6112 22.25 14.7562 27.3725C14.6887 27.7775 14.9662 28.1675 15.3712 28.235C15.7762 28.3025 16.1662 28.025 16.2337 27.62C16.9012 23.6675 21.2137 19.25 25.9987 19.25C30.7837 19.25 35.0962 23.6675 35.7562 27.62C35.8162 27.9875 36.1387 28.25 36.4987 28.25C36.5362 28.25 36.5812 28.25 36.6262 28.2425C37.0312 28.175 37.3087 27.785 37.2412 27.38C36.3862 22.25 31.1287 17.75 25.9987 17.75Z\"\n//           fill=\"white\" />\n//       </svg>\n//       <span class=\"showmore-btn__text txt20 txt20_caps\"\n//         >СМОТРЕТЬ ДЕТАЛЬНЕЕ</span\n//       >\n// </button>\n\n// --------------------------------------------------------------------------\n\n.link {\n    position: relative;\n    &::after {\n        content: '';\n        position: absolute;\n        top: calc(100% + 0.6rem);\n        left: 0;\n        width: 100%;\n        height: 2px;\n        background-color: $black;\n        transform-origin: center;\n        transform: scaleX(1);\n        transition: transform 0.3s ease;\n    }\n    @media (any-hover: hover) {\n        &:hover {\n            &::after {\n                transform: scaleX(0.25);\n            }\n        }\n    }\n    @media (max-width: 48em) {\n        &::after {\n            top: calc(100% + 1.2rem);\n        }\n    }\n\n    // .link__text\n\n    &__text {\n    }\n}\n// <a href=\"#\" class=\"link\"\n// ><span class=\"link__text txt20 txt20_caps\">ЗАГРУЗИТЬ ЕЩЕ</span></a\n// >\n","input[type='text'],\ninput[type='email'],\ninput[type='tel'],\ntextarea {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n}\ntextarea:focus,\ninput:focus {\n  outline: none;\n}\n\n.input {\n  position: relative;\n\n  &._form-focus {\n  }\n  &._form-error {\n    .input__field {\n      border-bottom: 1px solid $red;\n    }\n  }\n\n  // .input__field\n  &__field {\n    padding-bottom: 1.4rem;\n    display: block;\n    width: 100%;\n    border-radius: 0 !important;\n    border-bottom: 1px solid $black;\n    font-family: EuclidCircularA;\n    line-height: 1;\n    color: $black;\n    transition: border-bottom 0.3s ease;\n    &::placeholder {\n      color: $black;\n    }\n    @media (max-width: 48em) {\n      padding-bottom: 3rem;\n    }\n  }\n}\n\ntextarea.input {\n  padding: 0;\n  resize: none;\n}\n\n.form-error {\n  position: absolute;\n  top: calc(100% + 0.9rem);\n  left: 0;\n  color: $red;\n  @media (max-width: 48em) {\n    top: calc(100% + 1.8rem);\n  }\n}\n\n// <div class=\"input\">\n//           <input\n//             autocomplete=\"off\"\n//             type=\"text\"\n//             name=\"form[]\"\n//             data-error=\"Подсказка\"\n//             placeholder=\"Имя *\"\n//             class=\"input__field txt20 txt20_md\" />\n",".tabs {\n  // .tabs__navigation\n\n  &__navigation {\n    display: flex;\n    column-gap: 2rem;\n  }\n\n  // .tabs__title\n\n  &__title {\n  }\n\n  // .tabs__content\n\n  &__content {\n  }\n\n  // .tabs__body\n\n  &__body {\n  }\n}\n\n.tab {\n  padding: 1.6rem 3.3rem 1.9rem 3.3rem;\n  display: inline-flex;\n  justify-content: center;\n  align-items: center;\n  border: 1px solid $black;\n  border-radius: 4rem;\n  text-align: center;\n  transition: background-color 0.3s ease;\n  &._active {\n    background-color: $green;\n  }\n  @media (max-width: 48em) {\n    padding: 1.8rem 5rem;\n  }\n}\n\n// <div data-tabs class=\"tabs\">\n// <nav data-tabs-titles class=\"tabs__navigation\">\n//   <button type=\"button\" class=\"tabs__title txt20 txt20_caps tab _active\">\n//     Таб №1\n//   </button>\n//   <button type=\"button\" class=\"tabs__title txt20 txt20_caps tab\">Таб №2</button>\n//   <button type=\"button\" class=\"tabs__title txt20 txt20_caps tab\">Таб №3</button>\n// </nav>\n// <div data-tabs-body class=\"tabs__content\">\n//   <div class=\"tabs__body\">Содержимое первого таба</div>\n//   <div class=\"tabs__body\">Содержимое второго таба</div>\n//   <div class=\"tabs__body\">Содержимое третьего таба</div>\n// </div>\n// </div>\n",".accordion {\n  // .accordion__item\n\n  &__item {\n    border-radius: 4rem;\n    background-color: $green;\n  }\n\n  // .accordion__title\n\n  &__title {\n    padding: 3.2rem 3.2rem 3.2rem 4rem;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    width: 100%;\n    &._accordion-active {\n      .accordion__title-icon {\n        transform: rotate(-180deg);\n      }\n    }\n    @media (max-width: 48em) {\n      padding: 4rem;\n    }\n  }\n\n  // .accordion__title-icon\n\n  &__title-icon {\n    flex: 0 0 5rem;\n    width: 5rem;\n    height: 5rem;\n    transition: transform 0.3s ease;\n    @media (max-width: 48em) {\n      flex: 0 0 8rem;\n      width: 8rem;\n      height: 8rem;\n    }\n  }\n\n  // .accordion__title-txt\n\n  &__title-txt {\n  }\n\n  // .accordion__body\n\n  &__body {\n    padding: 4rem 3.2rem;\n    padding-top: 0;\n    @media (max-width: 48em) {\n      padding: 4rem;\n      padding-top: 0;\n    }\n  }\n\n  // .accordion__text\n\n  &__text {\n    font-family: EuclidCircularA;\n    max-width: 72.6rem;\n    @media (max-width: 48em) {\n      max-width: 62.2rem;\n    }\n  }\n}\n\n// <div data-accordion data-accordion-one-active class=\"accordion\">\n//           <div class=\"accordion__item\">\n//             <button type=\"button\" data-accordion-item class=\"accordion__title\">\n//               <svg\n//                 class=\"accordion__title-icon\"\n//                 width=\"52\"\n//                 height=\"52\"\n//                 viewBox=\"0 0 52 52\"\n//                 fill=\"none\"\n//                 xmlns=\"http://www.w3.org/2000/svg\">\n//                 <circle cx=\"26\" cy=\"26\" r=\"26\" fill=\"#1F1F22\" />\n//                 <path\n//                   d=\"M18.872 21L33 21L25.936 31.3605L18.872 21Z\"\n//                   fill=\"white\" />\n//               </svg>\n//               <span class=\"accordion__title-txt tl3\">Качество</span>\n//             </button>\n//             <div class=\"accordion__body\">\n//               <p class=\"accordion__text txt20\">\n//                 Мы придерживаемся высочайших стандартов и регулярно обновляем\n//                 наши навыки и техники, чтобы удовлетворить все потребности и\n//                 ожидания наших клиентов.\n//               </p>\n//             </div>\n//           </div>\n//         </div>\n",".select {\n    position: relative;\n    @media (min-width: 48em) {\n        min-width: 20.4rem;\n    }\n\n    // .select__body\n\n    &__body {\n        position: relative;\n    }\n\n    // .select__title\n\n    &__title {\n        border-radius: 4rem;\n        width: 100%;\n        background-color: $violet;\n        cursor: pointer;\n        text-align: left;\n        color: inherit;\n    }\n\n    // .select__value\n\n    &__value {\n        @extend .txt20_caps;\n        padding: 1.4rem 2.4rem;\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        gap: 1rem;\n        height: 5.2rem;\n        width: 100%;\n        font-family: DrukCyr;\n\n        > * {\n            flex: 1 1 auto;\n        }\n\n        &::after {\n            content: '';\n            flex: 0 0 2.4rem;\n            width: 2.4rem;\n            height: 2.4rem;\n            background-image: url(./assets/images/icons/arr.svg);\n            background-size: contain;\n            background-position: center;\n            background-repeat: no-repeat;\n            transition: transform 0.3s ease;\n            ._select-opened & {\n                transform: rotate(-180deg);\n            }\n        }\n        .select__content {\n            max-width: 31.4rem;\n            overflow: hidden;\n            white-space: nowrap;\n            text-overflow: ellipsis;\n        }\n        @media (max-width: 48em) {\n            padding: 1.8rem 4rem;\n            height: 8rem;\n            &::after {\n                flex: 0 0 5rem;\n                width: 5rem;\n                height: 5rem;\n            }\n        }\n    }\n\n    // .select__content\n\n    &__content {\n        // hide / show selected value\n        // display: none;\n    }\n\n    // .select__text\n\n    &__text {\n        flex: 1 1 auto;\n    }\n\n    // .select__input\n\n    &__input {\n        width: 100%;\n        height: 100%;\n        background-color: transparent;\n    }\n\n    // .select__options\n\n    &__options {\n        position: absolute;\n        z-index: 2;\n        top: calc(100% + 0.4rem);\n        left: 0;\n        padding: 1.2rem 2.8rem 2rem 1.2rem;\n        min-width: 100%;\n        box-shadow: 0 0.8rem 2.5rem 0 rgba(99, 119, 156, 0.2);\n        border-radius: 4rem;\n        background-color: $violet;\n        opacity: 0;\n        visibility: hidden;\n        transition: opacity 0.3s ease, visibility 0.3s ease;\n        .dropdown_sort & {\n            background-color: $white;\n        }\n        ._select-opened & {\n            opacity: 1;\n            visibility: visible;\n        }\n    }\n\n    // .select__scroll\n\n    &__scroll {\n        overflow-y: auto;\n        overflow-x: hidden;\n\n        // maximum height\n        max-height: 23.4rem;\n\n        // scrollbar styles\n        &.simplebar-scrollable-y {\n            .simplebar-track.simplebar-vertical {\n                top: 5rem;\n                right: 0;\n                width: 0.4rem;\n                border-radius: 0.8rem;\n                background-color: rgba(255, 255, 255, 0.4);\n            }\n            .simplebar-scrollbar {\n                min-height: 3.2rem;\n                border-radius: 0.8rem;\n                background-color: $white;\n            }\n        }\n        @media (max-width: 48em) {\n            max-height: 40rem;\n        }\n    }\n    // .select__option\n    &__option {\n        @extend .txt20_caps;\n        width: 95%;\n        padding: 1.2rem 3rem;\n        border-radius: 4rem;\n        font-family: DrukCyr;\n        text-align: left;\n        color: inherit;\n        transition: background-color 0.3s ease;\n        &._select-selected {\n            background-color: $white;\n            .dropdown_sort & {\n                background-color: $violet;\n            }\n        }\n        &:not(:last-child) {\n            position: relative;\n            margin-bottom: 1rem;\n            &::after {\n                content: '';\n                position: absolute;\n                top: calc(100% + 0.5rem);\n                left: 0;\n                width: 100%;\n                height: 1px;\n                background-color: rgba(204, 213, 251, 1);\n            }\n        }\n        @media (any-hover: hover) {\n            &:hover {\n                &:not(&.select__subtitle) {\n                    cursor: pointer;\n                    background-color: $white;\n                    .dropdown_sort & {\n                        background-color: $violet;\n                    }\n                }\n            }\n        }\n    }\n}\n// list\n._select-list {\n    cursor: pointer;\n}\n\n// <div class=\"dropdown dropdown_filters\">\n// <select data-no-slide data-show-selection data-sel-scroll=\"234\">\n//     <option value=\"1\" selected>Пункт №1</option>\n//     <option value=\"2\">Пункт №2</option>\n//     <option value=\"3\">Пункт №3</option>\n//     <option value=\"4\">Пункт №4</option>\n//     <option value=\"5\">Пункт №5</option>\n//     <option value=\"6\">Пункт №6</option>\n//     <option value=\"7\">Пункт №7</option>\n// </select>\n// </div>\n\n// <div class=\"dropdown dropdown_sort\">\n//      <select data-show-selection>\n//           <option value=\"1\" selected>Пункт №1</option>\n//           <option value=\"2\">Пункт №2</option>\n//           <option value=\"3\">Пункт №3</option>\n//           <option value=\"4\">Пункт №4</option>\n//      </select>\n// </div>\n",".option {\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    row-gap: 0.4rem;\n    cursor: pointer;\n\n    // .option__input\n    &__input {\n        position: absolute;\n        width: 0;\n        height: 0;\n        opacity: 0;\n        &:checked + .option__label .option__text::before {\n            border: 2px solid $green;\n        }\n        &:checked + .option__label .option__text::after {\n            transform: scale(0.6);\n        }\n    }\n\n    // .option__text\n    &__text {\n        display: inline-flex;\n        align-items: center;\n        gap: 1rem;\n        cursor: pointer;\n        &::before {\n            content: '';\n            align-self: flex-start;\n            flex: 0 0 3rem;\n            width: 3rem;\n            height: 3rem;\n            border-radius: 50%;\n            border: 2px solid rgba(233, 233, 233);\n            transition: border 0.3s ease;\n        }\n        &::after {\n            content: '';\n            position: absolute;\n            left: 0;\n            width: 3rem;\n            height: 3rem;\n            border-radius: 50%;\n            background-color: $green;\n            transform: scale(0);\n            transform-origin: center;\n            transition: transform 0.3s ease;\n        }\n        @media (max-width: 48em) {\n            &::before,\n            &::after {\n                width: 4rem;\n                height: 4rem;\n            }\n            &::before {\n                flex: 0 0 4rem;\n            }\n            &::after {\n                top: 4rem;\n            }\n        }\n    }\n}\n\n// <div class=\"option\">\n//    <input hidden id=\"o_1\" class=\"option__input\" checked type=\"radio\" value=\"1\" name=\"option\"/>\n//    <label for=\"o_1\" class=\"option__label\"><span class=\"option__text\"></span></label>\n//  </div>\n",".social {\n    display: flex;\n    align-items: center;\n    // .social__link\n    &__link {\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        width: 5.2rem;\n        height: 5.2rem;\n        background-color: $main;\n        border-radius: 50%;\n        transition: background 0.2s linear;\n\n        svg {\n            width: 2.2rem;\n            height: 2.2rem;\n        }\n\n        &:hover {\n            transition: background 0.2s linear;\n            background-color: $white;\n        }\n    }\n}\n\n@media (max-width: 48em) {\n    .social {\n        // .social__link\n        &__link {\n            width: 8rem;\n            height: 8rem;\n\n            svg {\n                width: 3.6rem;\n                height: 3.6rem;\n            }\n        }\n    }\n}\n",".hero-gallery {\n    padding-bottom: 16rem;\n    background-color: $bodyColor;\n\n    // .hero-gallery__container\n\n    &__container {\n        display: flex;\n        flex-direction: column;\n    }\n\n    // .hero-gallery__head\n\n    &__head {\n        align-self: center;\n        text-align: center;\n    }\n\n    // .hero-gallery__title\n\n    &__title {\n        color: $pink;\n        &.tl1 {\n            font-size: 19rem;\n        }\n        ._coloured-txt {\n            color: $green;\n        }\n    }\n\n    // .hero-gallery__body\n\n    &__body {\n        position: relative;\n        height: 63rem;\n    }\n\n    // .hero-gallery__item\n\n    &__item {\n        position: absolute;\n        border-radius: 1.5rem;\n        background-color: #29292c;\n        overflow: hidden;\n        &._a {\n            top: 0;\n            left: 0;\n            width: 8.6rem;\n            height: 8rem;\n        }\n        &._b {\n            top: 0;\n            left: 10.8rem;\n            width: 14.3rem;\n            height: 8.8rem;\n        }\n        &._c {\n            top: 0;\n            left: 28.2rem;\n            width: 26.3rem;\n            height: 12.2rem;\n        }\n        &._d {\n            top: 0;\n            left: 57.3rem;\n            width: 15.8rem;\n            height: 10.2rem;\n        }\n        &._e {\n            top: 0;\n            left: 76rem;\n            width: 29.7rem;\n            height: 10.7rem;\n        }\n        &._f {\n            top: 0;\n            left: 108.9rem;\n            width: 12.4rem;\n            height: 10.2rem;\n        }\n        &._g {\n            top: 0;\n            left: 124.4rem;\n            width: 19rem;\n            height: 9.6rem;\n        }\n        &._h {\n            top: 0;\n            right: 0;\n            width: 26.3rem;\n            height: 29rem;\n        }\n        &._i {\n            top: 11.3rem;\n            left: 0;\n            width: 25.1rem;\n            height: 12.6rem;\n        }\n        &._j {\n            top: 14.7rem;\n            left: 27.7rem;\n            width: 9.2rem;\n            height: 9.2rem;\n        }\n        &._k {\n            top: 14.6rem;\n            left: 39.2rem;\n            width: 14.4rem;\n            height: 9.4rem;\n        }\n        &._l {\n            top: 13.2rem;\n            left: 55.8rem;\n            width: 27.8rem;\n            height: 13.4rem;\n        }\n        &._m {\n            top: 13.2rem;\n            left: 86.5rem;\n            width: 26.9rem;\n            height: 13.4rem;\n        }\n        &._n {\n            top: 13.2rem;\n            left: 115.9rem;\n            width: 26.8rem;\n            height: 23.5rem;\n        }\n        &._o {\n            top: 26.3rem;\n            left: 1.9rem;\n            width: 23.2rem;\n            height: 13.2rem;\n        }\n        &._p {\n            top: 26.3rem;\n            left: 27.7rem;\n            width: 18.4rem;\n            height: 10.4rem;\n        }\n        &._q {\n            top: 29.2rem;\n            left: 48.9rem;\n            width: 18.8rem;\n            height: 10.1rem;\n        }\n        &._r {\n            top: 29.2rem;\n            left: 70.2rem;\n            width: 12.1rem;\n            height: 15rem;\n        }\n        &._s {\n            top: 29.2rem;\n            left: 84.8rem;\n            width: 27.8rem;\n            height: 15.8rem;\n        }\n        &._t {\n            top: 39.1rem;\n            left: 116.2rem;\n            width: 22.3rem;\n            height: 14.2rem;\n        }\n        &._u {\n            top: 39rem;\n            left: 140.5rem;\n            width: 6.4rem;\n            height: 5.2rem;\n        }\n        &._v {\n            top: 31.4rem;\n            left: 149.2rem;\n            width: 9.1rem;\n            height: 18.3rem;\n        }\n        &._w {\n            top: 31.4rem;\n            right: 0;\n            width: 11.4rem;\n            height: 8.1rem;\n        }\n        &._x {\n            top: 41.7rem;\n            left: 11.9rem;\n            width: 11.5rem;\n            height: 6.5rem;\n        }\n        &._y {\n            top: 39.1rem;\n            left: 26.1rem;\n            width: 21rem;\n            height: 10.9rem;\n        }\n        &._z {\n            top: 42.1rem;\n            left: 49.5rem;\n            width: 14.1rem;\n            height: 11.5rem;\n        }\n        &._a1 {\n            top: 47.4rem;\n            left: 65.9rem;\n            width: 17.1rem;\n            height: 15.7rem;\n        }\n        &._b1 {\n            top: 49.5rem;\n            left: 85.4rem;\n            width: 14.3rem;\n            height: 13.6rem;\n        }\n        &._c1 {\n            top: 48.6rem;\n            left: 102.2rem;\n            width: 11.4rem;\n            height: 8.1rem;\n        }\n        &._d1 {\n            top: 39.1rem;\n            left: 116.2rem;\n            width: 22.3rem;\n            height: 14.2rem;\n        }\n        &._e1 {\n            top: 45.7rem;\n            left: 140.9rem;\n            width: 5.7rem;\n            height: 5.7rem;\n        }\n        &._f1 {\n            top: 41.5rem;\n            right: 0;\n            width: 10.4rem;\n            height: 6.6rem;\n        }\n\n        // .hero-gallery__item_gray\n\n        &_gray {\n            background-color: $gray;\n        }\n    }\n\n    // .hero-gallery__image-wrap\n\n    &__image-wrap {\n        display: block;\n    }\n\n    // .hero-gallery__image\n\n    &__image {\n        object-fit: cover;\n    }\n\n    // .hero-gallery__footer\n\n    &__footer {\n        display: flex;\n        justify-content: space-between;\n        align-items: flex-start;\n    }\n\n    // .hero-gallery__group\n\n    &__group {\n        display: flex;\n        flex-direction: column;\n        align-items: flex-start;\n    }\n\n    // .hero-gallery__text\n\n    &__text {\n        margin-bottom: 4.4rem;\n        display: flex;\n        column-gap: 2.8rem;\n        max-width: 40rem;\n        &::before {\n            content: '';\n            width: 9.4rem;\n            height: 1px;\n            background-color: rgba(201, 251, 64, 0.5);\n            transform: translateY(1.5rem);\n        }\n    }\n\n    // .hero-gallery__showmore-btn\n\n    &__showmore-btn {\n    }\n\n    // .hero-gallery__btn\n\n    &__btn {\n    }\n}\n",".main-collection {\n    background-color: #cad2f4;\n    padding: 16rem 0;\n    margin-bottom: 16rem;\n    // .main-collection__inner\n    &__inner {\n        display: flex;\n        align-items: center;\n        justify-content: space-between;\n        gap: 8rem;\n    }\n    // .main-collection__cards\n    &__cards.swiper {\n        position: relative;\n        width: 83.6rem;\n        height: 73.3rem;\n        margin: 0;\n    }\n    &__cards-item.swiper-slide {\n        display: flex;\n\n        width: 51.5rem;\n        height: 51.5rem;\n        border-radius: 4rem;\n        position: absolute;\n        padding: 1.2rem;\n        overflow: hidden;\n    }\n    // .main-collection__title\n    &__title {\n        margin-bottom: 2rem;\n\n        width: 69.5rem;\n    }\n    // .main-collection__description\n    &__description {\n        margin-bottom: 5rem;\n        width: 61.8rem;\n        color: $gray;\n    }\n    // .main-collection__info\n    &__info {\n        color: $black;\n    }\n}\n.collection-item {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n\n    &--rat {\n        top: 0;\n        left: 0;\n        z-index: 2;\n\n        background: linear-gradient(223deg, #8792ed 1.18%, #5f6eda 34.96%, #6778df 68.58%, #8792ed 100%);\n    }\n    &--snail {\n        right: -2rem;\n        bottom: 0;\n        z-index: 1;\n\n        background: linear-gradient(226deg, #455265 0%, #11161e 40.66%, #11161e 60.6%, #455265 103.07%);\n    }\n\n    // .collection-item__header\n    &__header {\n        display: flex;\n        align-items: center;\n        justify-content: space-between;\n    }\n    // .collection-item__title\n    &__title {\n        display: flex;\n        flex-direction: column;\n        padding-left: 1.2rem;\n        .txt20 {\n            opacity: 0.7;\n        }\n\n        strong {\n            text-align: left;\n        }\n\n        span {\n            text-align: left;\n        }\n    }\n    // .collection-item__icons\n    &__icons {\n        display: flex;\n        align-items: center;\n        gap: 0.7rem;\n        &-item {\n            width: 8rem;\n            height: 8rem;\n            border-radius: 50%;\n            background: rgba(255, 255, 255, 0.3);\n            backdrop-filter: blur(13px);\n\n            display: flex;\n            align-items: center;\n            justify-content: center;\n\n            svg {\n                display: block;\n                width: 4.4rem;\n                height: 4.4rem;\n            }\n        }\n    }\n    // .collection-item__footer\n    &__footer {\n        display: flex;\n        align-items: center;\n        justify-content: space-between;\n        &-item {\n            display: flex;\n            width: 24.1rem;\n            height: 6.8rem;\n            padding: 1.6rem;\n            justify-content: center;\n            align-items: center;\n            border-radius: 5.2rem;\n\n            &--left {\n                background: rgba(255, 255, 255, 0.3);\n                backdrop-filter: blur(30px);\n            }\n            &--right {\n                background: $white;\n                backdrop-filter: blur(11.5px);\n                align-self: flex-end;\n                color: $black;\n\n                strong {\n                    margin: 0 0.5rem;\n                    align-self: center;\n                }\n                span {\n                    align-self: flex-end;\n                    margin-bottom: 0.2rem;\n                }\n                sup {\n                    align-self: flex-start;\n                }\n            }\n        }\n    }\n    // .collection-item__backdrop\n    &__backdrop {\n        position: absolute;\n        top: 0;\n        left: 0;\n        z-index: -1;\n        width: 100%;\n        height: 100%;\n        padding: 3.2rem;\n\n        img {\n            width: 100%;\n            height: auto;\n            object-fit: contain;\n        }\n    }\n}\n\n@media (max-width: 48em) {\n    .main-collection {\n        padding: 10rem 0;\n        &__container {\n            padding: 0;\n        }\n        // .main-collection__inner\n        &__inner {\n            display: flex;\n            align-items: center;\n            flex-direction: column;\n            justify-content: space-between;\n            gap: 6.4rem;\n        }\n        // .main-collection__cards\n        &__cards.swiper {\n            order: 2;\n            position: relative;\n            width: 100%;\n            height: auto;\n            margin: 0;\n            padding: 0 2rem;\n        }\n\n        &__cards-item.swiper-slide {\n            width: 65.8rem;\n            height: 67rem;\n            border-radius: 4rem;\n            position: static;\n            padding: 2.4rem;\n            overflow: hidden;\n        }\n\n        // .main-collection__info\n        &__info {\n            order: 1;\n            display: flex;\n            flex-direction: column;\n            align-items: center;\n            padding: 0 2rem;\n        }\n        // .main-collection__title\n        &__title {\n            width: 90%;\n            text-align: center;\n            margin-bottom: 2.4rem;\n        }\n        // .main-collection__description\n        &__description {\n            font-size: 2.8rem;\n            text-align: center;\n            margin-bottom: 6.4rem;\n            width: 93%;\n        }\n    }\n    .collection-item {\n        &--snail {\n            right: 0;\n        }\n        // .collection-item__title\n        &__title {\n            padding-left: 0;\n\n            strong {\n                margin-bottom: 1rem;\n            }\n        }\n        // .collection-item__icons\n        &__icons {\n            gap: 1rem;\n            &-item {\n                svg {\n                    width: 4.6rem;\n                    height: 4.6rem;\n                }\n            }\n        }\n        // .collection-item__footer\n        &__footer {\n            &-item {\n                display: flex;\n                width: 30rem;\n                height: 8.8rem;\n                padding: 2.4rem;\n                border-radius: 4rem;\n                &--right {\n                    strong {\n                        margin: 0 0.5rem;\n                        align-self: center;\n                    }\n                    span {\n                        margin-bottom: 0;\n                    }\n                }\n            }\n        }\n    }\n}\n",".main-links {\n  margin-top: 5.2rem;\n  margin-bottom: 0;\n  // .main-links__list\n  &__list {\n    display: flex;\n    align-items: center;\n    flex-direction: column;\n  }\n  // .main-links__item\n  &__item {\n    width: 100%;\n    text-align: center;\n    color: $white;\n    font-family: 'DrukCyr';\n    font-size: 10rem;\n    font-style: normal;\n    font-weight: 500;\n    line-height: normal;\n    transition: background 0.3s linear, color 0.3s linear;\n\n    border-top: 0.1rem solid rgba(201, 243, 43, 0.5);\n\n    &:hover {\n      transition: background 0.3s linear, color 0.3s linear;\n      background-color: $yellow;\n      color: $main;\n    }\n    a {\n      display: block;\n      width: 100%;\n      padding: 0.6rem 0;\n    }\n    &--big {\n      font-size: 19.9646rem;\n      line-height: 23.387rem; /* 117.143% */\n\n      a {\n        padding: 1.8rem 0 3.4rem;\n      }\n    }\n  }\n}\n\n@media (max-width: 48em) {\n  .main-links {\n    margin-top: 0;\n    margin-bottom: 7.6rem;\n    // .main-links__list\n    &__list {\n      display: flex;\n      align-items: center;\n      flex-direction: column;\n    }\n    // .main-links__item\n    &__item {\n      line-height: 110%;\n      border-top: 0.2rem solid rgba(201, 243, 43, 0.5);\n      a {\n        padding: 2.4rem 0;\n      }\n      &--big {\n        font-size: 11rem;\n        line-height: 110%; /* 117.143% */\n\n        a {\n          padding: 2.4rem 0;\n        }\n      }\n    }\n  }\n}\n",".main-rates {\n    margin-bottom: 21.7rem;\n    // .main-rates__inner\n    &__inner {\n        display: flex;\n        align-items: center;\n        flex-direction: column;\n        gap: 9rem;\n    }\n    // .main-rates__title\n    &__title {\n        color: $white;\n    }\n    // .main-rates__wrapper\n    &__wrapper {\n        display: flex;\n        flex-direction: column;\n        gap: 4rem;\n        width: 100%;\n    }\n    // .main-rates__item\n    &__item {\n        height: 18rem;\n        display: flex;\n        align-items: center;\n        border-radius: 3rem;\n    }\n}\n.rates-item {\n    position: relative;\n\n    &::before,\n    &::after {\n        content: '';\n        width: 5.1rem;\n        height: 5.1rem;\n        border-radius: 50%;\n        background: #1f1f22;\n\n        position: absolute;\n        z-index: 1;\n        top: 50%;\n        transform: translateY(-50%);\n    }\n\n    &::after {\n        right: -2.5rem;\n    }\n    &::before {\n        left: -2.5rem;\n    }\n    &--bg--pink {\n        background: #ff69c2;\n    }\n    &--bg--blue {\n        background: #cad2f4;\n    }\n    &--bg--green {\n        background: $green;\n    }\n    // .rates-item__left\n    &__left {\n        padding: 3.6rem 3.6rem 3.6rem 8.6rem;\n        height: 100%;\n        width: 57.8rem;\n        display: flex;\n        align-items: center;\n        border-right: 0.3rem dashed $main;\n    }\n    // .rates-item__title\n    &__title {\n        color: #1f1f22;\n    }\n    // .rates-item__right\n    &__right {\n        display: flex;\n        align-items: center;\n        gap: 20.2rem;\n        height: 100%;\n        padding-left: 9.3rem;\n    }\n    // .rates-item__price\n    &__price {\n        &-top {\n            color: #1f1f22;\n\n            strong {\n                color: #1f1f22;\n                margin: 0 0.5rem;\n                align-self: center;\n            }\n            span {\n                align-self: flex-end;\n                margin-bottom: 0.2rem;\n            }\n            sup {\n                align-self: flex-start;\n            }\n        }\n        &-bottom {\n            color: $main;\n        }\n    }\n    // .rates-item__options\n    &__options {\n        width: 16rem;\n        color: $main;\n    }\n    // .rates-item__icon\n    &__icon {\n        position: absolute;\n    }\n}\n.rates-icon {\n    &--sunny {\n        top: -5rem;\n        left: 14.3rem;\n        width: 9.7rem;\n        height: 8rem;\n        transform: rotate(-7.376deg);\n    }\n    &--shapes {\n        right: 35.6rem;\n        top: -4.3rem;\n        width: 9.2rem;\n        height: 9rem;\n        transform: rotate(-15deg);\n    }\n    &--megafon {\n        width: 8.7rem;\n        height: 7rem;\n        transform: rotate(-12.401deg);\n        right: 68.6rem;\n        bottom: -3.5rem;\n    }\n}\n\n@media (max-width: 48em) {\n    .main-rates {\n        // .main-rates__inner\n        &__inner {\n            gap: 10rem;\n        }\n        // .main-rates__item\n        &__item {\n            height: 56rem;\n            border-radius: 4rem;\n            flex-direction: column;\n        }\n    }\n    .rates-item {\n        &::before,\n        &::after {\n            width: 9rem;\n            height: 9rem;\n        }\n        &::after {\n            right: -4.5rem;\n        }\n        &::before {\n            left: -4.5rem;\n        }\n        // .rates-item__left\n        &__left {\n            padding: 4.8rem;\n            height: 13.4rem;\n            width: 100%;\n            justify-content: center;\n            border-right: 0;\n            border-bottom: 0.3rem dashed $main;\n        }\n        // .rates-item__title\n        &__title {\n            font-size: 3rem;\n        }\n        // .rates-item__right\n        &__right {\n            flex-direction: column;\n            width: 100%;\n            gap: 4rem;\n            height: auto;\n            padding-left: 0;\n            padding-top: 2.4rem;\n        }\n        // .rates-item__price\n        &__price {\n            &-top {\n                strong {\n                    margin: 0 1rem;\n                }\n                span {\n                    align-self: flex-end;\n                    margin-bottom: 0;\n                }\n                sup {\n                    align-self: flex-start;\n                }\n            }\n            &-bottom {\n                color: $main;\n            }\n        }\n        // .rates-item__options\n        &__options {\n            width: 80%;\n            text-align: center;\n\n            display: flex;\n            justify-content: center;\n            margin-bottom: 2.8rem;\n        }\n        // .rates-item__icon\n        &__icon {\n            display: none;\n        }\n    }\n}\n"],"sourceRoot":""}]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!../sass-loader/dist/cjs.js!./swiper.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!./node_modules/sass-loader/dist/cjs.js!./node_modules/swiper/swiper.css");
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6__);
/* harmony reexport (unknown) */ var __WEBPACK_REEXPORT_OBJECT__ = {};
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in _css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6__) if(__WEBPACK_IMPORT_KEY__ !== "default") __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => _css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6__[__WEBPACK_IMPORT_KEY__]
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()((_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6___default()), options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6___default()) && (_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6___default().locals) ? (_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_sass_loader_dist_cjs_js_swiper_css__WEBPACK_IMPORTED_MODULE_6___default().locals) : undefined);
...
/******/ })()
;
//# sourceMappingURL=index972bb4abf7bd57c2734f.js.map